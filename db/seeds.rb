...
t6 = Tag.create(name: "Relevés bancaire", category: finance, validity: 10, number_of_uploads: 1)
t7 = Tag.create(name: "Bulletins de salaire", category: emploi, validity: 10*365, number_of_uploads: 4)
